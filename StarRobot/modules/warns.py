...
from StarRobot import TIGERS, WOLVES, dispatcher
from StarRobot.modules.disable import DisableAbleCommandHandler
from StarRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from StarRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from StarRobot.modules.helper_funcs.string_handling import split_quotes
from StarRobot.modules.log_channel import loggable
from StarRobot.modules.sql import warns_sql as sql
