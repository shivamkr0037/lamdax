...
import StarRobot.modules.sql.global_bans_sql as gban_sql
import StarRobot.modules.sql.users_sql as user_sql
from StarRobot import DEV_USERS, OWNER_ID, dispatcher
